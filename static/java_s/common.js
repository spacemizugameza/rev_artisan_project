...
$(document).ready(function () {
    ...
    //custom move title
    var best_title = $('.best-products .tabs-style');
    var best_col_image = $('.best-products .col-large-image');
    best_title.appendTo(best_col_image);
    var features_title = $('.featured-products .tabs-style');
    var features_col_image = $('.featured-products .col-large-image');
    features_title.appendTo(features_col_image);
